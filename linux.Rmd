...
- **Absolute** path: we start from the root
ex: `/Users/cedric/projects/ikewai/data/my_file.csv`
- **Relative** path: we start from our current location
ex: `../data/my_file.csv` (if my current folder is `src/`)
...
- Specific symbols
  ...
  (therefore `../..` is the parent of the parent)
...
Syntax: 
  - classic: `if [ ... ]; then ...; elif [...] do ...; else ... ; done`
...
# Day 3: Customization and history search
